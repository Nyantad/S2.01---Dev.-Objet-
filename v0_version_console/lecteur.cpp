...
void Lecteur::avancer()
{
    if (nbImages() > 0)
    {
        _posImageCourante = (_posImageCourante + 1) % nbImages(); // incrémente la position, modulo le nombre d'images
    }
}
...
unsigned int Lecteur::numDiaporamaCourant() // retourne le numéro du diaporama courant
{
